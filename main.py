...
for epoch in range(num_epochs):
    ...
    #print('train_mae: ', train_mae[epoch])
    print('train_mse: ', train_mse[epoch])
    print('test_mse: ', test_mse[epoch])
    ...
    ax.plot(xax[0:epoch+1], train_mse[0:epoch+1], lw=0.5, linewidth=1, color='r', marker='o',markerfacecolor='b', label='train', linestyle='-',
            markersize=1)
    ax.plot(xax[0:epoch + 1], test_mse[0:epoch + 1], lw=0.5, linewidth=1, color='k', marker='o', markerfacecolor='b',
