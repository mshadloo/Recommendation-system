...
h1_th=Dense(200,activation='tanh',kernel_regularizer=l2(0))(r_i_th)
...
h1_sel=Dense(200,activation=selu,kernel_regularizer=l2(0))(r_i_sel)
...
h1_sp=Dense(200,activation=softplus,kernel_regularizer=l2(0))(r_i_sp)
...
ax.plot(xax, val_mse_sel,  linewidth=1, color='r', marker='o',markerfacecolor='b', label='selu', linestyle='-', markersize=1)
ax.plot(xax, val_mse,  linewidth=1, color='k', marker='o', markerfacecolor='b',
            label='tanh', linestyle='-',markersize=1)
ax.plot(xax, val_mse_sp,  linewidth=1, color='g', marker='o', markerfacecolor='b',
            label='softplus', linestyle='-',markersize=1)
ax.legend()
plt.show(block=False)
plt.savefig('activation_200units.png')